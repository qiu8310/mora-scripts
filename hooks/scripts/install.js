...
var moraPkgFile = resolve(__dirname, '../../package.json')
var moraPkg = require(moraPkgFile)
...
function isRelyOnCurrentPkg() {
  var name = moraPkg.name
  try {
    var pkg = require(findup.pkg())
    return pkg.name === name // 是项目本身
